...
const sections: FrameworkSection[] = [
  ...
  },
  {
    ...
    content: [
      "Not all hours are equal. The framework structures the trading day into four distinct phases, each with a specific function. All times are UTC.",
      "Asian session (19:00–23:00 UTC): the accumulation phase. Liquidity pools are building on both sides of the range. No active trading. Set alerts on Asian highs and lows — these become the targets for London manipulation. This is observation time, not execution time.",
      "London manipulation window (23:00–07:00 UTC): the highest-probability phase in the framework. Institutional order flow engineers a sweep of the Asian range — taking out stops above or below the overnight high/low — before reversing. The sequence to watch for: sweep of Asian extreme → displacement candle → CHoCH on the lower timeframe → FVG formation. The setup is formed during this window. By the time London business hours open (10:00 UTC+2 / 08:00 UTC), the manipulation is complete and the structural shift is already visible.",
      "Neutral zone (07:00–12:30 UTC): do nothing. Price is digesting the London move. There is no structural edge during this window. Entering here means chasing a move that has already happened. The framework requires a hard stop on trade execution during this period.",
      "New York delivery (12:30–19:00 UTC): NY opens at 13:30 UTC and provides the delivery leg. If the London window formed a valid CHoCH and FVG, this is where price returns to fill that FVG and continue in the direction established by the manipulation. Entries occur on FVG retests within this window. This is the execution phase — the setup was formed in London, NY delivers the move.",
